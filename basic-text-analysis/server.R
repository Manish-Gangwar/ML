...
#               Basic Text Analysis             #
#################################################
try(require(shiny) || install.packages("shiny"));library(shiny)
try(require(text2vec) || install.packages("text2vec"));library(text2vec)
try(require(tm) || install.packages("tm"));library(tm)
try(require(tokenizers) || install.packages("tokenizers"));library(tokenizers)
try(require(wordcloud) || install.packages("wordcloud"));library(wordcloud)
try(require(slam) || install.packages("slam"));library(slam)

try(require(stringi) || install.packages("stringi"));library(stringi)
try(require(magrittr) || install.packages("magrittr"));library(magrittr)
try(require(tidytext) || install.packages("tidytext"));library(tidytext)
try(require(dplyr) || install.packages("dplyr"));library(dplyr)
